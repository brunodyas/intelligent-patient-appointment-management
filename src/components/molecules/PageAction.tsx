...
const PageAction: React.FC<PageAction> = ({
  ...
  return (
    ...
    >
      <section
        className={`flex w-full items-center justify-between rounded-lg-10 border border-neutral-30/75 bg-white px-6 py-4 shadow-2`}
      >
        <div className='flex items-center gap-2'>
          <ChecksIcon className='h-5 w-5 fill-neutral-60' />

          <h5 className='text-xs font-semibold text-neutral-60'>
